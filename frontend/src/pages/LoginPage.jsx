            ...
            <nav className={`relative z-50 border-b border-white/20 dark:border-slate-700/50 backdrop-blur-md bg-white/40 dark:bg-slate-900/40 transition-all duration-500 ${pageLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-4'}`}>
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
                    ...
                    <div className="flex gap-4">
                        ...
                        <button className="px-6 py-2 text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white font-medium transition-colors duration-200 border-b-2 border-transparent hover:border-slate-300 dark:hover:border-slate-600">
                            Register
                        </button>
                    </div>
                </div>
