...
export default function AIInsightsPanel({ tasks, isDark }) {
  ...
  return (
    <div className={`rounded-2xl backdrop-blur-md p-6 shadow-2xl ring-1 ${isDark ? 'bg-gradient-to-br from-slate-800/80 to-blue-900/40 ring-blue-700/30' : 'bg-gradient-to-br from-white/80 to-blue-50/80 ring-blue-200/30'}`}>
